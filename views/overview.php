      ...
      <div class="col-lg-4 d-flex flex-column">
        <div>
          <div class="row flex-grow">
            ...
            <!-- data visitor -->
            <?php if (mysqli_num_rows($tbl_pengunjung) > 0) {
              while ($row = mysqli_fetch_assoc($tbl_pengunjung)) { ?>
                        ...
                        <div class="col-sm-6">
                          <div class="d-flex justify-content-between align-items-center mb-2 mb-sm-0">
                            <div>
                              ...
                              <h4 class="mb-0 fw-bold"><?= $row['pengunjung'] ?></h4>
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <p class="text-small">Data update pada tanggal <?php $date_pengunjung = date_create($row['updated_at']);
                                                                          echo date_format($date_pengunjung, "l, d M Y h:i a"); ?></p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card card-rounded">
                <div class="card-body card-rounded">
                  ...
                  <div class="list align-items-center pt-3">
                    <div class="wrapper w-100">
                      <p class="mb-0">
                        <a style="cursor: pointer;" onclick="window.location.href='category'" class="fw-bold text-primary">Show all <i class="mdi mdi-arrow-right ms-2"></i></a>
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div class="card card-rounded">
              <div class="card-body">
                <div class="d-sm-flex justify-content-between align-items-start">
                  ...
                  <div>
                    <button class="btn btn-primary btn-lg text-white mb-0 me-0" type="button" onclick="window.location.href='location'"><i class="mdi mdi-map-marker-plus"></i>Tambah Lokasi</button>
                  </div>
                </div>
            ...
            <div class="card card-rounded">
              <div class="card-body">
                <div class="d-sm-flex justify-content-between align-items-start">
                  ...
                  <div>
                    <button class="btn btn-primary btn-lg text-white mb-0 me-0" type="button" onclick="window.location.href='tour'"><i class="mdi mdi-map-marker-radius"></i>Tambah Wisata</button>
                  </div>
                </div>
                <div class="table-responsive  mt-1">
                  <table class="table select-table text-center">
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                      <div class="modal-body">
                                        <div class="mb-3">
                                          ...
                                          <input type="text" name="judul" value="<?= $row['judul'] ?>" class="form-control" id="judul" placeholder="" required>
                                        </div>
                                        <div class="mb-3">
                                          <label for="deskripsi" class="form-label">Deskripsi</label>
